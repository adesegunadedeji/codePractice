...
//        var answer = word1 === word2 ? true: false;
//        return answer;
//     }
//     return false;
// }
...
factorial = (number)=>{
    let value = number === 0 || number ===1 ? 1: number * factorial(number-1);
    return value;
...
regexExpression = (number)=>{
number = number.toString();
return number.replace(/\d(?=\d{4})/g, "*");
}

// const str = '1234123412341234';
// var test = str.substring(0, 12).replace();
// const regex = 
// console.log(test);


console.log(regexExpression(1234123412341234));